...
- 表型准确率尚未通过人工参考验证；
- 跨作物迁移已经封存，不得主动扩展。
- 人工复核协作规范与可复现打包脚本位于`experiment/manual_review_system/`。方案C首轮train/val已完成：重复性F1中位数0.933，二维拆分的A/B/C/D总路径数为64/76/63/74。平台三40张独立人工复核也已完成：路径pass/fail=`36/4`，漏叶yes=`7`、错连yes=`7`、基部wrong=`6`，严格联合通过26/40；相对路线B的22/40有混合净变化，不能据此证明新Teacher或D方案优越。2026-08-02已冻结A/B/C/D并取消D的推荐候选身份；下一步只完成平台四中性配对诊断。旧32/40表型入口门槛已取消，平台四后转入模型盲的小型V4 val表型参考与Teacher-direct vs Student对照；正式消融、五随机种子和V4 test继续后置。人工判断只用于评价，不作为关键点训练标签。
