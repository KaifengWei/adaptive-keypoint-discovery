...
"$PYTHON_BIN" generate_g1prime_pseudolabels.py \
  ...
  --device cuda \
  --full-transforms
"$PYTHON_BIN" train_adaptive_point_detector.py --config configs/train_core_dinov2.json --dry-run
"$PYTHON_BIN" train_adaptive_point_detector.py --config configs/train_core_dinov2.json
